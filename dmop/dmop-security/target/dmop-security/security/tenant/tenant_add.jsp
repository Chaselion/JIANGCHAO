...
function resetForm() {
	$("#tenantForm")[0].reset();
	$("#tenantForm").validate().resetForm();
	$("#userForm")[0].reset();
	$("#userForm").validate().resetForm();
	//$("#funcForm")[0].reset();
	
	/*
	$('input[name="radioSalePack"]:checked').each(function() {
							...
							<form id="tenantForm" class="form-horizontal ">
								...
								<div class="row">
									...
									<div class="form-group col-md-6">
									  ...
									  <div class="col-md-10">
										<input type="text" id="telephone" name="v" class="form-control" maxlength="50"> 
									  </div>
									</div>
								</div>
								<div class="row">
					...
					<div class="widget">
						...
						<div class="widget-content" style="padding-top:5px;">
							<form id="userForm" class="form-horizontal ">
								...
								<div class="form-group">
								  <label class="col-md-1 control-label">密码 <span class="required">*</span> :</label>
								  <div class="col-md-11">
									<input type="password" id="password" name="password" class="form-control required" maxlength="32"> 
								  </div>
								</div>
								<div class="form-group">
								  <label class="col-md-1 control-label">确认密码 <span class="required">*</span> :</label>
								  <div class="col-md-11">
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <p>新增租户成功！ <ul><li>点击【继续添加】新增其他记录。</li><li>点击【返回列表】查看租户列表。</p>
      </div>
