		...
		$("#roleList").data("datatable", {
			...
			"columnDefs": [{
				...
				"render": function ( data, type, full, meta) {
				  ...
				  var checkedStr = data.checked ? "checked" : "";
				  return "<input value=\"" + data.id + "\" type=\"checkbox\" " + checkedStr + ">";
				},
		...
		$.post("user/getUserWithRole", requestData, function(data) {
			if (data.commonMessage.success) {
				...
				if (user.organization) {
					$("#hiddenOrgId").val(user.organization.id);
					$("#txtParentOrg").val(user.organization.name);
				}
