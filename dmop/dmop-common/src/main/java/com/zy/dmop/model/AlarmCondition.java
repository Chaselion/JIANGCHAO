...
public class AlarmCondition   implements Serializable{
	 ...
	 * 
	 */
	private static final long serialVersionUID = -908686198460079568L;
	//主键id
	...
	public AlarmCondition(Integer alarmConditionId, Integer alarmStrategyId, Integer customId, Integer deviceClassId,
			Integer deviceProperityId, Integer ifActive, Integer ifAutoPromote, Integer ifRelieveNotice,
			Integer initialAlarmLevelId, Integer judgeRule, Integer promoteCondition, Integer relieveDuration,
			Integer repeatTime, Integer triggerDuration, String conditionName, Double judgeJuniorValue,
			Double judgeSeniorValue, String note, Double promoteValue, Date createDateTime, Date modifyDateTime) {
		super();
	...
	public String toString() {
		return "AlarmCondition [alarmConditionId=" + alarmConditionId + ", alarmStrategyId=" + alarmStrategyId
				...
				+ ", conditionName=" + conditionName + ", judgeJuniorValue=" + judgeJuniorValue + ", judgeSeniorValue="
				+ judgeSeniorValue + ", note=" + note + ", promoteValue=" + promoteValue + ", createDateTime="
