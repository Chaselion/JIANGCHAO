...
function addRole() {
	...
	if (linkname == "") {
		showNoty("请填写联系人的【名称】!", "error", false, 'top');
		return;
	}
	if (linkphone == "") {
		showNoty("请填写联系人的【电话】!", "error", false, 'top');
		return;
	}
	if (location == "") {
		showNoty("请填写客户所属地区!", "error", false, 'top');
		return;
	}
	if (expiretime == "") {
        ...
        <div class="col-md-12">
		  <div class="widget box">
            <div class="widget-header">
              <h4><i class="icon-reorder"></i> 新增客户信息 ${titleLabel}</h4>
            </div>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <p>新增客户成功！ <ul><li>点击【继续添加】新增其他记录。</li><li>点击【返回列表】查看客户列表。</p>
      </div>
