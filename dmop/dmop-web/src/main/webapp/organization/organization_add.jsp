...
function getalarm() {
    $.post("organization/queryAlarmStrategy", "", function(data) {
	  if (data.commonMessage.success) {
		...
		jqCompanyList.append('<option value="-1">= 报警策略 =</option>');
    ...
    <div class="container">
      <div class="crumbs">
        <ul id="breadcrumbs" class="breadcrumb">
          <li> <i class="icon-home"></i> <a href="organization/organization.jsp">组织管理</a> </li>
            ...
            <div class="widget-content">
              <form id="addOrgForm" class="form-horizontal ">
                ...
                <div class="form-group" style="display:none">
                  <label class="col-md-2 control-label">客户id <span class="required">*</span> :</label>
                  <div class="col-md-10">
                    <input type="text" id="customid" name="orgName" class="form-control required" maxlength="50"> <label id="orNameErrorMSG" style="color:red;"></label>
                  </div>
                ...
                <div class="form-group">
                  <label class="col-md-2 control-label">报警策略id <span class="required">*</span> :</label>
                  <div class="col-md-10">
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-10">
                    <input type="text" id="note" name="orgName" class="form-control required" maxlength="50"> <label id="orNameErrorMSG" style="color:red;"></label>
                  </div>
