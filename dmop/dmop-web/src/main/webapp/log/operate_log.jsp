...
<%=basePath%>
	...
	function requestRemove() {
		...
		if (id != undefined) {
			...
			$.ajax({
				type : "POST",
				url : "operateLog/delOperateLogById",
				data : requestData,
				dataType : "json",
	...
	function queryRole(start) {
		...
		$.post('operateLog/pageQueryOperateLog', requestData,
				function(data) {

					var operateLogs = data.operateLogs;
					var page = data.page;
					...
					$("#roleList").DataTable().rows.add(operateLogs).draw();
		...
		<div id="content">
				...
				<div style="padding-top: 5px;">
					...
					<div class="col-md-6" style="width: 100%">
						<button id="btnOutPut" class="btn btn-primary" type="button"
							onclick="javascript:exportshow();"
							style="width: auto; float: left;">导出</button>
			...
			<div class="col-md-12">
				<table id="roleList"
					...
					<thead>
						<tr>
							<th class="align-center" style="width: 5%; text-align: center;">#</th>
							<!-- <th class="align-center">id</th> -->
							<th class="align-center col-md-2" style="width: 15%;">日志记录时间</th>
							<th class="align-center" style="width: 15%;">所属组织</th>
							<th class="align-center" style="width: 15%;">用户</th>
							<th class="align-center" style="width: auto;">内容</th>
						</tr>
					</thead>
				</table>
			</div>
								...
								<div class="form-group">
									...
									<div class="col-md-10">
										<input type="text" id="roleName" name="roleName"
											class="form-control readonly-white" readonly maxlength="50">
									</div>
								</div>
								<div class="form-group">
									...
									<div class="col-md-10">
										<textarea id="roleDescription" name="roleDescription" rows="3"
											class="form-control readonly-white" readonly maxlength="450"> </textarea>
									</div>
								</div>
								<div class="form-group">
									...
									<div class="col-md-10">
										<div
											style="height: 200px; width: 100%; border: 1px solid #d9d9d9; overflow-y: auto">
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title">导出操作日志</h4>
      </div>
      <div class="modal-body">
        <p>您确定要导出操作日志吗?</p>
      </div>
