...
<%=basePath%>
	...
	function requestRemove() {
		...
		if (id != undefined) {
			...
			$.ajax({
				type : "POST",
				url : "realtimeLog/delRealTimeLogById",
				data : requestData,
				dataType : "json",
	...
	function queryRole(start) {
		...
		$.post('realtimeLog/pageQueryRealtimeLog', requestData,
				function(data) {

					var realTimeLogs = data.realTimeLogs;
					var page = data.page;
					...
					$("#roleList").DataTable().rows.add(realTimeLogs).draw();
				...
				"data" : "text"
																...
																"render": function ( data, type, full, meta ) {   
																	...
																	var html = '<ul class="table-controls"> ';
																		...
																		html += '<li><a href="javascript:remove(' + data.systemLogId + ');" class="bs-tooltip" title="删除"><i class="icon-trash"></i></a></li> ';
		...
		$.post("role/getRole", requestData,
				function(data) {
					if (data.commonMessage.success) {
						...
						globalFuncTree = $.fn.zTree.init($("#funcTree"),
								zTreeSettingCheck, funcs);
			...
			<div class="container">
				...
				<div style="padding-top: 5px;">
					...
					<div class="col-md-6" style="width: 100%;">
						...
						<!-- <button id="delSelectedBtn" class="btn btn-primary">删除选中</button> -->
					</div>
					<script type="text/javascript">
					...
					<div class="col-md-6">
						<div style="float: right; display: inline-block; width: 270px;">
							...
							<input type="text" class="form-control" id="txtSearchName" placeholder="输入名称进行过滤" value="" />
				...
				<div class="col-md-12">
					<table id="roleList"
						...
						<thead>
							<tr>
								<th class="col-md-1 align-center" style="width: 5%;">#</th>
								<th class="col-md-2 align-center" style="width: 15%">日志记录时间</th>
								<th class="col-md-1 align-center" style="width: 15%">日志级别</th>
								<th class="col-md-3 align-center" style="width: 10%">所属模块</th>
								<th class="col-md-4 align-center" style="width: auto;">内容</th>
...
<div id="dlgConfirmexport" class="modal">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
        <h4 class="modal-title">导出运行日志</h4>
      </div>
      <div class="modal-body">
        <p>您确定要导出运行日志吗?</p>
      </div>
