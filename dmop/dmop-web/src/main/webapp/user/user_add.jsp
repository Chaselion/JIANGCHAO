...
<![endif]-->
<link
	href="<%=basePath%>plugins/jquery-easyui-1.4.2/themes/bootstrap/tree.css"
	rel="stylesheet" type="text/css">
<link
	href="<%=basePath%>plugins/jquery-easyui-1.4.2/themes/bootstrap/datagrid.css"
	rel="stylesheet" type="text/css">
<link
	href="<%=basePath%>plugins/jquery-easyui-1.4.2/themes/bootstrap/panel.css"
	rel="stylesheet" type="text/css">
<style>
div.form-group {
	margin-bottom: 5px;
			...
			<div class="container">
				<div class="crumbs">
					<ul id="breadcrumbs" class="breadcrumb">
						<li><i class="icon-home"></i> <a href="user/user.jsp">用户管理</a>
						</li>
					...
					<div id="addWrapper" class="col-md-12">
						<div class="widget">
							<div class="widget-header">
								<h5>
									<i class="icon-angle-right"></i> 用户基本信息
								</h5>
							</div>
							...
							<div class="widget-content" style="padding-top: 5px;">
								<form id="addForm" class="form-horizontal ">
									...
									<div class="form-group">
										...
										<div class="col-md-6">
											<input type="password" id="confirmPassword"
												...
												equalto="[name='password']" maxlength="32">
										</div>
									</div>
									<div class="form-group">
									...
									<div class="form-group">
										...
										<div class="col-md-6">
											<input type="text" id="mobilePhone" name="mobilePhone"
												class="form-control digits required" maxlength="11">
										</div>
									</div>
									<div class="form-group">
										<label class="col-md-2 control-label">电子邮箱 <span
											class="required">*</span> :
										</label>
										<div class="col-md-6">
											...
											<div class="input-group">
												<input id="txtParentOrg" type="text" class="form-control"
													...
													<button class="btn btn-default"
														onclick="javascript:chooseParentOrg();" type="button">选择</button>
												</span>
											</div>
										</div>
										<label id="parentOrgErrorMSG" for="txtParentOrg" class=""
											style="display: none">必选字段</label>
									</div>

									<div class="form-group">
										<label class="col-md-2 control-label">账号状态 <span
											class="required">*</span> :
										</label>
										<div class="col-md-6">
									...
									<div class="form-group">
										<label class="col-md-2 control-label">用户权限组  :</label>
										<div class="col-md-10">
							...
							<div class="row">
								<div class="col-md-12">
									<div class="col-md-offset-2 col-md-10">
										<button id="backBtn" class="btn pull-right">返&nbsp;回
										</button>
