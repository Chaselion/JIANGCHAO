...
public class CarStateDataEcuParser {
	private static Logger log = Logger.getLogger(CarStateDataEcuParser.class);
	public static final String KEY_terminalID = "terminalID";//终端号
	public static final String KEY_DumpEnergy = "DumpEnergy";//剩余电量
	public static final String KEY_Workload = "Workload";//负载
	public static final String KEY_BatteryVoltage="BatteryVoltage";
	public static final String KEY_InnerTemperature = "InnerTemperature";//机内温度
