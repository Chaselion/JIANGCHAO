...
private static Logger log = Logger.getLogger(LineGraphController.class);
	...
	public Map<String, Object> getAlarmLogs(
		...
		terminalId = StringUtil.convertNullToEmpty(terminalId);
			...
			HashSet<Map<String, Object>> alarmLog = lineGraphService.getAlarmLogs(organizationId, terminalId, startTime, endTime);
